...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest sistemacompras.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`sistemacompras.client.esproj`).
